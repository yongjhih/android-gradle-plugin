...
public class ManualBuildTest extends BuildTest {
    ...
    public void testDensitySplitWithOldMerger() throws Exception {
        ...
        Map<String, VersionData> expected = Maps.newHashMapWithExpectedSize(5);
        expected.put("universal", VersionData.of(112));
        expected.put("mdpi",      VersionData.of(212));
        expected.put("hdpi",      VersionData.of(312));
        expected.put("xhdpi",     VersionData.of(412));
        expected.put("xxhdpi",    VersionData.of(512));

        checkVersion(project, null, expected, "densitySplitWithOldMerger");
    }
